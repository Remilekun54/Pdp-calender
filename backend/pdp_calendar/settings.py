"""
Django settings for pdp_calendar project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-pdp-akinyele-calendar-dev-key-change-in-production')
...
# Fallback wildcard for any onrender subdomains
...
ROOT_URLCONF = 'pdp_calendar.urls'
...
WSGI_APPLICATION = 'pdp_calendar.wsgi.application'
